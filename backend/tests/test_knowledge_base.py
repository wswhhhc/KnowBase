...
class KnowledgeBaseTests(unittest.TestCase):
    ...
    def test_prepare_splits_adds_stable_chunk_metadata(self):
        ...
        # Contextual retrieval prepends context prefix
        self.assertIn("本段属于文档", splits[0].page_content)
        self.assertIn("同一段测试内容", splits[0].page_content)
        self.assertEqual(metadata["original_content"], "同一段测试内容")
...
class KnowledgeBaseDeleteAndCountTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Inject sample documents directly and flag as loaded
